package com.dse.reservoir.api.fxwz.wzkzgl.service;
...
public interface WzkzglService {
    /**
     * 查询仓库基础信息
     *
     * @param args   参数
     ...
     * @return
     */
    public EasyUiPage getCrkListInfoByParams(String typs,String sTime,String eTime,String dep_id,String ck_id,String statu, EasyUiPage easyUiPage);
