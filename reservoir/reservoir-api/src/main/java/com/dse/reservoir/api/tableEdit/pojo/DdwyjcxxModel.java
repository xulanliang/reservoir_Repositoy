 ...
 */
@Entity
@Table(name = "WR_MSFT_B")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class DdwyjcxxModel implements Serializable {
    private static final long serialVersionUID = 1L;

    @EmbeddedId
    private  DdwyjcxxPK id;     //联合主键
    ...
    public DdwyjcxxPK getId() {
        return id;
    }

    public void setId(DdwyjcxxPK id) {
        this.id = id;
    }
