...
define(["dojo/dom", "dojo/on", "dojo/_base/declare",
    ...
    "esri/domUtils",
    "dojo/dom-style",
], function (dom, on, declare, arrayUtils, domConstruct, string, lang, sniff, mouse, _BaseTool, BaseMapUtils, AgsMap, domUtils, domStyle) {
    //
    // var _map = null;
    //
    var polySelf = null;
    ...
    var module = declare([_BaseTool], {
        ...
        _createCompareMapCtn: function (domNode) {
            ...
            //
            baseMapUtils = new BaseMapUtils(map2);
            baseMapUtils.loadBaseLayers([appConfig.mapCompare]);
            //
            //
...
//# sourceMappingURL=CompareTool.js.map