...
define(["dojo/dom", "dojo/on", "dojo/_base/declare",
    ...
    "./_BaseTool"
], function (dom, on, declare, Array, sniff, Draw, Graphic, Point, GraphicsLayer, geometryEngine, Polyline, SimpleLineSymbol, SimpleFillSymbol, TextSymbol, PictureMarkerSymbol, SimpleMarkerSymbol, webMercatorUtils, _BaseTool) {
    //
    var drawTool = null;
    var showPt = null;
    //
    ...
    var symbolConfig = (function () {
        return {
            ...
            "closeSymbol": {
                "type": "esriPMS",
                "url": window.dseGisPath + window.styleName + "/img/delete.png",
                "width": 16,
                "height": 16,
                "angle": 0,
                "xoffset": 11,
        ...
        _addEventListeners: function () {
            ...
            mapClickHandler = _map.on("click", function (event) {
                ...
                if (lastPoint && current) {
                    ...
                    showPt = current;
                    var results = temp + distance;
                    //每段距离小于100米是不在地图中绘制.
                    if (results > 100) {
                        lineSelf._setVertexGraphic(current);
                        showMeasureResultByGraphic(textSymbol, results, "");
                        temp = 0;
                    }
                    else {
                        temp += distance;
...
//# sourceMappingURL=PolylineTool.js.map