define(['dojo/_base/declare'], function (declare) {
    ...
    var mo = (function () {
        ...
        return {
            ...
            /**转换线坐标点
             * @param source 输入的坐标串，格式: x,y;x,y;x,y example: 114.071590,22.592750;114.073610,22.592420
             * @param maptype 当前底图坐标系类型. 1为经纬度，2为墨卡托，3为百度坐标系，
             * @author wangsl
             * @date 2017-05-23
             * */
            getStringLineRing: function (source, maptype) {
                ...
                if (source) {
                    ...
                    items.forEach(function (item, index) {
                        ...
                        if (maptype === "1") {
                            results.push([parseFloat(points[0]), parseFloat(points[1])]);
                        }
                        else if (maptype === "2") {
                            //
                            // debugger;
                            var web102100 = self.WgsToDqzb(parseFloat(points[0]), parseFloat(points[1]), maptype);
                            results.push(web102100);
                        }
                        else if (maptype === "3") {
                            //
                        }
...
//# sourceMappingURL=dseGisUtils.js.map