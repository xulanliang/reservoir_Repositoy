...
define(["dojo/_base/declare", "esri/layers/TiledMapServiceLayer", "esri/geometry/Extent",
    "esri/SpatialReference", "esri/layers/TileInfo"], function (declare, TiledMapServiceLayer, Extent, SpatialReference, TileInfo) {
    //
    var googleLayer = declare([TiledMapServiceLayer], {
        ...
        getTileUrl: function (level, row, col) {
            //
            var layerId = this._getLayerType(this.layerType);
            if (layerId) {
                //
                return "http://mt" + (col % 4) + ".google.cn/vt/lyrs=" + layerId + "&hl=zh-CN&gl=cn&" + "x=" + col + "&" +
                    "y=" +
                    row +
                    "&" +
                    "z=" +
...
//# sourceMappingURL=GoogleTiledLayer.js.map