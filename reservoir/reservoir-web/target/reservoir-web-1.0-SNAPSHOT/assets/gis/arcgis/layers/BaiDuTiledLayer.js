...
define(["dojo/_base/declare",
    ...
    "esri/geometry/Extent", "esri/layers/TileInfo"], function (declare, TiledMapServiceLayer, SpatialReference, Extent, TileInfo) {
    //
    var tileUrl = "";
    return declare([TiledMapServiceLayer], {
        ...
        getTileUrl: function (level, row, col) {
            var zoom = level - 1;
            var offsetX = parseInt(Math.pow(2, zoom).toString());
            ...
            else if (this.layerType === "annotation") {
                //
...
//# sourceMappingURL=BaiDuTiledLayer.js.map