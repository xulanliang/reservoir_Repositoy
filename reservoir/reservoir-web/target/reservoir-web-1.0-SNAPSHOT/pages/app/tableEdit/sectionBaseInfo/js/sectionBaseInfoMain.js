...
//
require_js('wzcfdxx_search', 'pages/app/tableEdit/sectionBaseInfo/js/sectionBaseInfoDatagrid', ['eform','oper_config']);
require_js('wzcfdxx_datagrid', 'pages/app/tableEdit/sectionBaseInfo/js/sectionBaseInfoSearch', ['wzcfdxx_search', 'datagrid_pager']);
require_shim('stylePage', ['wzcfdxx_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('sectionBaseInfoMain', function (require, exports, module) {
