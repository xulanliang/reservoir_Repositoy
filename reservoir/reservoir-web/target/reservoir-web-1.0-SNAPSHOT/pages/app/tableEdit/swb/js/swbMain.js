...
//
require_js('wzcfdxx_search', 'pages/app/tableEdit/swb/js/swbDatagrid', ['eform','oper_config']);
require_js('wzcfdxx_datagrid', 'pages/app/tableEdit/swb/js/swbSearch', ['wzcfdxx_search', 'datagrid_pager']);
require_shim('stylePage', ['wzcfdxx_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('swbMain', function (require, exports, module) {
