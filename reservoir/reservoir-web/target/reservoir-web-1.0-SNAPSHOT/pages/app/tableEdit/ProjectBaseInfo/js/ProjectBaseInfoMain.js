...
//
require_js('wzcfdxx_search', 'pages/app/tableEdit/ProjectBaseInfo/js/ProjectBaseInfoDatagrid', ['eform','oper_config']);
require_js('wzcfdxx_datagrid', 'pages/app/tableEdit/ProjectBaseInfo/js/ProjectBaseInfoSearch', ['wzcfdxx_search', 'datagrid_pager']);
require_shim('stylePage', ['wzcfdxx_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('ProjectBaseInfoMain', function (require, exports, module) {
