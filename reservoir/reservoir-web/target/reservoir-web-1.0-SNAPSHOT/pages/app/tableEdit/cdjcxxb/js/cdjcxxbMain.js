...
//
require_js('wzcfdxx_search', 'pages/app/tableEdit/cdjcxxb/js/cdjcxxbDatagrid', ['eform','oper_config']);
require_js('wzcfdxx_datagrid', 'pages/app/tableEdit/cdjcxxb/js/cdjcxxbSearch', ['wzcfdxx_search', 'datagrid_pager']);
require_shim('stylePage', ['wzcfdxx_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('cdjcxxbMain', function (require, exports, module) {
