...
//
require_js('wzcfdxx_search', 'pages/app/tableEdit/rainLever/js/rainLeverDatagrid', ['eform','oper_config']);
require_js('wzcfdxx_datagrid', 'pages/app/tableEdit/rainLever/js/rainLeverSearch', ['wzcfdxx_search', 'datagrid_pager']);
require_shim('stylePage', ['wzcfdxx_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('rainLeverMain', function (require, exports, module) {
