...
require_js('wzcfxx_search', 'pages/app/fxwz/wzcfxx/js/wzcfxxSearch', ['eform','oper_config']);
require_js('wzcfxx_datagrid', 'pages/app/fxwz/wzcfxx/js/wzcfxxDatagrid', ['wzcfxx_search', 'datagrid_pager']);
require_shim('stylePage', ['wzcfxx_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('wzcfxxMain', function (require, exports, module) {
    ...
    DSE.app = new Vue({
        ...
        methods: {
            ...
            doBatchDelete: function () {
                ...
                DSE.form.deleteDatagridRow('所选数据', 'wzcfxxCtrl/deleteInfoByIds.do', {status: false});
            },
            //查询
            doSearch: function () {
                DSE.form.doSearch();
