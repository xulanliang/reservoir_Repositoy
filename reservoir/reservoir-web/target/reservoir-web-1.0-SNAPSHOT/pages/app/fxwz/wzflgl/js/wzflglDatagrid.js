...
DSE.form.initDatagrid = function(params, _data) {
    ...
    var _keyId = 'MA_TYPE_ID', //主键ID,根据业务修改,删除也是用的此字段
        _url = DSE.serverPath + '/wzflglCtrl/getListInfoByParams.do', //数据请求地址
        ...
        columns: [
            [{
                ...
                formatter: function (value, rowData, rowIndex) {
                    ...
                    op += '<a href="javascript:" onclick="DSE.form.deleteDatagridRow(\'所选数据\', \'wzflglCtrl/deleteInfoByIds.do\', {status: false,ids:\'' + rowData[_keyId] + '\'})"><i class="fa fa-trash-o"></i> 删除</a>';
                    op += '</div>';
                    return op;
                }
            }
