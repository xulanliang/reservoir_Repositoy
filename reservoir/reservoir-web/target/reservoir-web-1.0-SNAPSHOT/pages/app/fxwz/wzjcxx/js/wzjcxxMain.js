...
require_js('wzjcxx_search', 'pages/app/fxwz/wzjcxx/js/wzjcxxSearch', ['eform']);
require_js('wzjcxx_datagrid', 'pages/app/fxwz/wzjcxx/js/wzjcxxDatagrid', ['wzjcxx_search', 'datagrid_pager']);
require_shim('stylePage', ['wzjcxx_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('wzjcxxMain', function (require, exports, module) {
    ...
    DSE.app = new Vue({
        ...
        methods: {
            ...
            doBatchDelete: function () {
                ...
                DSE.form.deleteDatagridRow('所选数据', 'wzjcxxCtrl/deleteInfoByIds.do', {status: false});
            },
            //查询
            doSearch: function () {
                DSE.form.doSearch();
