...
DSE.form.initDatagrid = function(params, _data) {
    ...
    var _keyId = 'WZID', //主键ID,根据业务修改,删除也是用的此字段
        _url = DSE.serverPath + '/wzjcxxCtrl/getListInfoByParams.do', //数据请求地址
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function (value, rowData, rowIndex) {
                    //链接查看详情
                    return '<a href="javascript:" class="f-link3" onclick="DSE.form.showEditOrDetail(\'' + rowData[_keyId] + '\',\'物资基础信息详情\',\'detail\',\'./addOrEdit/addOrEdit.html\')">' + nullToSpace(value) + '</a>';
                }
            }, {
                field: 'WZDW',
                title: '物资计量单位',
                ...
                formatter: function (value, rowData, rowIndex) {
                    ...
                    op += '<a href="javascript:" onclick="DSE.form.deleteDatagridRow(\'所选数据\', \'wzjcxxCtrl/deleteInfoByIds.do\', {status: false,ids:\'' + rowData[_keyId] + '\'})"><i class="fa fa-trash-o"></i> 删除</a>';
                    op += '</div>';
                    return op;
                }
            }
