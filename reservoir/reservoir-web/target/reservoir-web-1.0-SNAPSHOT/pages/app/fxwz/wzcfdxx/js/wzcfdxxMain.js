...
//
require_js('wzcfdxx_search', 'pages/app/fxwz/wzcfdxx/js/wzcfdxxSearch', ['eform','oper_config']);
require_js('wzcfdxx_datagrid', 'pages/app/fxwz/wzcfdxx/js/wzcfdxxDatagrid', ['wzcfdxx_search', 'datagrid_pager']);
require_shim('stylePage', ['wzcfdxx_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('wzcfdxxMain', function (require, exports, module) {
