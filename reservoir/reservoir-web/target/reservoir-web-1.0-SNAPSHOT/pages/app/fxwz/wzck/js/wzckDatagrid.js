        ...
        columns: [
            [{
                ...
                formatter: function (value, rowData, rowIndex) {
                    ...
                    op += '<a href="javascript:" class="f-mr10" onclick="DSE.form.showEditOrDetail(\'' + rowData[_keyId] + '\',\'查看物资出库信息\',\'detail\',\'./addOrEdit/addOrEdit.html\')"><i class="fa fa-edit"></i> 查看</a>';
                    /*if(rowData.STATUS != 3){
                        op += '<a href="javascript:" class="f-mr10" onclick="DSE.form.showEditOrDetail(\'' + rowData[_keyId] + '\',\'编辑物资出库信息\',\'edit\',\'./addOrEdit/addOrEdit.html\')"><i class="fa fa-edit"></i> 编辑</a>';
