...
require_js('comm_fxwzSearch', 'pages/app/fxwz/js/comm_addOrEdit', ['eform',,'datagrid_pager']);
require_js('datagrid', 'pages/app/fxwz/wrmapatrolb/addOrEdit/js/datagrid', ['comm_fxwzSearch']);
require_shim('stylePage', ['datagrid']);
    ...
    var app = new Vue({
        data: function() {
            return {
                ...
                flag: true, //防止多次保存
                isflood: parent.DSE.app.isflood,　　//0:日常检查 1：汛前查询及养护 2：汛后检查及养护
            }
        },
        methods: {
            doCloseWin: function() {
