...
require_js('wrmapatrolb_search', 'pages/app/fxwz/js/comm_fxwzSearch', ['eform']);
require_js('wrmapatrolb_datagrid', 'pages/app/fxwz/wrmapatrolb/js/wrmapatrolbDatagrid', ['wrmapatrolb_search', 'datagrid_pager']);
require_shim('stylePage', ['wrmapatrolb_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('wrmapatrolbMain', function (require, exports, module) {
    var _stylePage = require('stylePage');

    //引入 Vue + ElementUI
    var Vue = require('vue'),
        vue_component = require('vue_component'),
        wrmapatrolb_search = require('wrmapatrolb_search'),
    ...
    DSE.app = new Vue({
        ...
        methods: {
            ...
            doBatchDelete: function () {
                ...
                DSE.form.deleteDatagridRow('所选数据', 'wrmapatrolbCtrl/deleteInfoByIds.do', {status: false});
            },
            //查询
            doSearch: function () {
                DSE.form.doSearch();
    ...
    DSE.app.is_flood=$.getParam("is_flood");
