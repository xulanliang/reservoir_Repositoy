...
require_js('wzkzgl_search', 'pages/app/fxwz/js/comm_fxwzSearch', ['eform','oper_config']);
require_js('wzkzgl_datagrid', 'pages/app/fxwz/wzkzgl/js/wzkzglDatagrid', ['wzkzgl_search', 'datagrid_pager']);
require_shim('stylePage', ['wzkzgl_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('wzkzglMain', function (require, exports, module) {
    var _stylePage = require('stylePage');

    //引入 Vue + ElementUI
    var Vue = require('vue'),
        vue_component = require('vue_component'),
        wzkzgl_search = require('wzkzgl_search'),
