...
require_js('wzxxglsearch_search', 'pages/app/fxwz/js/comm_fxwzSearch',['eform','oper_config']);
require_js('wzxxglsearch_datagrid', 'pages/app/fxwz/wzxxglsearch/js/wzxxglsearchDatagrid', ['wzxxglsearch_search', 'datagrid_pager']);
require_shim('stylePage', ['wzxxglsearch_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('wzxxglsearchMain', function (require, exports, module) {
    var _stylePage = require('stylePage');

    //引入 Vue + ElementUI
    var Vue = require('vue'),
        vue_component = require('vue_component'),
        wzxxglsearch_search = require('wzxxglsearch_search'),
