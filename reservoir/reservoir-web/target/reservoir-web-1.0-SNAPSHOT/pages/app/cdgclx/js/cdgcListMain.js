...
//
require_js('wzcfdxx_search', 'pages/app/cdgclx/js/cdgcListDatagrid', ['eform','oper_config']);
require_js('wzcfdxx_datagrid','pages/app/cdgclx/js/cdgcListSearch', ['wzcfdxx_search', 'datagrid_pager']);
require_shim('stylePage', ['wzcfdxx_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('cdgcListMain', function (require, exports, module) {
