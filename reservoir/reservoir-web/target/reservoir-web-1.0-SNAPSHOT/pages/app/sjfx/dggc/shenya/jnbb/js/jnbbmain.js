...
require_js('jnbb_search', 'pages/app/sjfx/dggc/shenya/jnbb/js/jnbbsearch', ['eform']);
require_js('jnbb_datagrid', 'pages/app/sjfx/dggc/shenya/jnbb/js/jnbbdatagrid', ['jnbb_search', 'datagrid_pager']);
    ...
    DSE.app = new Vue({
        ...
        methods: {
            ...
            doExport: function () {
                ...
                var url= DSE.serverPath + '/shenyaCtrl/exportSZSKJnbbExcel.do?' +searchData +'&queryType=dggc' +'&rows='+rows  + '&fileName='+encodeURIComponent(encodeURIComponent(fileName));
                window.location.href = url ;
                /*var exportType = '渗压-季年报表';
                $.ajax({
                    url: DSE.serverPath + '/shenyaCtrl/getjnbbListDg.do',
                    async: false,
                    data: {
                    ...
                    success: function (data) {
                        $.ajax({
                            ...
                            type: 'post',
                            success: function (data) {
                              //  window.location.href = decodeURI(DSE.serverPath + '/excelController/downExcel.do?exportId=' + data.data + '&shortName=渗压-季年报表.xlsx');
                                var shortName='渗压-季年报表.xlsx';
