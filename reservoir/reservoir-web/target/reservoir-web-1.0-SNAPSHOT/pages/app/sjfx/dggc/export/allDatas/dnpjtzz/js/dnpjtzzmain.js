...
require_js('dnpjtzz_search', 'pages/app/sjfx/dggc/export/allDatas/dnpjtzz/js/dnpjtzzsearch', ['eform']);
require_js('dnpjtzz_datagrid', 'pages/app/sjfx/dggc/export/allDatas/dnpjtzz/js/dnpjtzzdatagrid', ['dnpjtzz_search', 'datagrid_pager']);
...
define('dnpjtzzmain', function(require, exports, module) {
    ...
    DSE.app = new Vue({
        ...
        methods: {
            ...
            //导出
            doExport: function () {
                var exportType = '东改工程-多年平均特征值报表';
                $.ajax({
                    url: DSE.serverPath + '/dggcAllDataCtr/getDnpjtzzList.do',
                    ...
                    success: function (data) {
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                var shortName='东改工程-多年平均特征值报表.xlsx';
