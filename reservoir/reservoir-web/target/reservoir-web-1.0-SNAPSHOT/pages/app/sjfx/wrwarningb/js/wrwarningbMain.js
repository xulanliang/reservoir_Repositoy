...
require_js('wrwarningb_search', 'pages/app/sjfx/wrwarningb/js/wrwarningbSearch', ['eform']);
require_js('wrwarningb_datagrid', 'pages/app/sjfx/wrwarningb/js/wrwarningbDatagrid', ['wrwarningb_search', 'datagrid_pager']);
require_shim('stylePage', ['wrwarningb_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('wrwarningbMain', function (require, exports, module) {
