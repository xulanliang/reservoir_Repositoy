...
require_js('jnbb_search', 'pages/app/sjfx/szsk/swqx/jnbb/js/jnbbsearch', ['eform']);
require_js('jnbb_datagrid', 'pages/app/sjfx/szsk/swqx/jnbb/js/jnbbdatagrid', ['jnbb_search', 'datagrid_pager']);
...
define('jnbbmain', function(require, exports, module) {
    ...
    DSE.app = new Vue({
        ...
        methods: {
            ...
            //导出
            doExport: function() {
                var exportType = '水文气象-季年报表';
                $.ajax({
                    url: DSE.serverPath + '/swqxCtrl/getjnbbList.do',
                    async: false,
                    data: {
                    ...
                    success: function(data) {
                        $.ajax({
                            ...
                            type: 'post',
                            success: function(data) {
                                //window.location.href = decodeURI(DSE.serverPath + '/excelController/downExcel.do?exportId=' + data.data + '&shortName=水文气象-季年报表.xlsx');
                                var shortName='水文气象-季年报表.xlsx';
