...
require_js('spwygcx_search', 'pages/app/sjfx/szsk/spwy/spwygcx/js/spwygcxsearch', ['eform']);
        ...
        methods: {
            ...
            doReset: function() {
                ...
                */
                ...
                var jsonurl=DSE.baseUrl + '/gcxCtrl/getSpwyGcxChartData.do?t='+t.getMilliseconds()+'&stm='+ this.minDate+'&etm='+this.maxDate+'&wrrbm_rbcd='+this.wrrbm_rbcd+'&projcd='+this.projcd+'&wrprojb_proj_cd='+this.wrprojb_proj_cd;
