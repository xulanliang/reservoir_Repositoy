...
require_js('zxfbt_search', 'pages/app/sjfx/szsk/czwy/zxfbt/js/zxfbtsearch', ['eform']);
        ...
        methods: {
            ...
            doReset: function() {
                ...
                */
                ...
                var jsonurl=DSE.baseUrl + '/gcxCtrl/getCzwyZxfbtGcxChartData.do?t='+t.getMilliseconds()+'&stm='+ this.minDate+'&etm='+this.maxDate+'&wrrbm_rbcd='+this.wrrbm_rbcd+'&projcd='+this.projcd+'&wrprojb_proj_cd='+this.wrprojb_proj_cd;
