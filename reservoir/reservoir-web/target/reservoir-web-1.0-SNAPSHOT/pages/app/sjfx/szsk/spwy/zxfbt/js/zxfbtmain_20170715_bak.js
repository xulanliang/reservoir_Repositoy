...
require_js('zxfbt_search', 'pages/app/sjfx/szsk/spwy/zxfbt/js/zxfbtsearch', ['eform']);
...
/*
                ...
                */
                ...
                var jsonurl=DSE.baseUrl + '/gcxCtrl/getSpwyZxfbtGcxChartData.do?t='+t.getMilliseconds()+'&stm='+ this.minDate+'&etm='+this.maxDate+'&wrrbm_rbcd='+this.wrrbm_rbcd+'&projcd='+this.projcd+'&wrprojb_proj_cd='+this.wrprojb_proj_cd;
