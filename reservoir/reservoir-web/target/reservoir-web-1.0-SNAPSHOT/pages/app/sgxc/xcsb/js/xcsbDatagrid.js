    ...
    var datagridOptions = {
        ...
        columns: [
            [{
                ...
                formatter: function (value, rowData, rowIndex) {
                //链接查看详情
                return '<a href="javascript:" class="f-link3" onclick="DSE.form.showEditOrDetail(\'' + rowData[_keyId] + '\',\'巡查任务信息\',\'detail\',\'../xcsb/checkPoints/checkPointsPage.html?ck_re_id='+ rowData[_keyId]+'&ck_obj_id='+ rowData['CK_OBJ_ID']+'\')">' + nullToSpace(value) + '</a>';
                }
            }, {
                field: 'CK_RE_ECOUNT',
                title: '异常点数',
                ...
                formatter: function (value, rowData, rowIndex) {
                    ...
                    if(rowData.STATUS=='0' || rowData.STATUS=='1'){
                        op += '<a href="javascript:" class="f-link3" onclick="DSE.form.showEditOrDetail(\'' + rowData[_keyId] + '\',\'巡查任务信息\',\'detail\',\'./roportContent/roportContent.html?isNotSaved='+rowData.STATUS+'&ck_re_id='+ rowData[_keyId]+'&ck_obj_id='+ rowData['CK_OBJ_ID']+'\')"><i class="fa fa-edit"></i>上报</a>';
                    }else if(rowData.STATUS=='2'){
                        op += '<a href="javascript:" class="f-link3" onclick="DSE.form.showEditOrDetail(\'' + rowData[_keyId] + '\',\'巡查任务信息\',\'detail\',\'./roportContent/roportContent.html?ck_re_id='+ rowData[_keyId]+'&ck_obj_id='+ rowData['CK_OBJ_ID']+'\')"><i class="fa fa-edit"></i>编辑</a>';
                    }
                    op += '</div>';
                    return op;
                }
