...
require_js('wrchkobject_search', 'pages/app/sgxc/js/comm_sgxcSearch', ['eform']);
require_js('wrchkobject_datagrid', 'pages/app/sgxc/wrchkobject/js/wrchkobjectDatagrid', ['wrchkobject_search', 'datagrid_pager']);
require_shim('stylePage', ['wrchkobject_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('wrchkobjectMain', function (require, exports, module) {
    ...
    DSE.app = new Vue({
        data: function () {
            return {
                ...
                ck_item:$.getParam("ck_item"),//巡查对象分类(0:巡查对象,1:巡查点)
                ck_item_name:"巡查对象",//巡查对象分类(0:巡查对象,1:巡查点)
                type:parent.type,
            }
        },
        methods: {
            ...
            doOpenWin: function () {
                ...
                if (this.url === '') {
                    this.url = './addOrEdit/addOrEdit.html?ck_item='+DSE.app.ck_item;
                }
            },
            //关闭
            doCloseWin: function () {
            ...
            doBatchDelete: function () {
                ...
                DSE.form.deleteDatagridRow('所选数据', 'wrchkobjectCtrl/deleteInfoByIds.do', {status: false});
            },
            //查询
            doSearch: function () {
                DSE.form.doSearch();
    ...
    //巡查对象分类
    DSE.app.ck_item_name=DSE.app.ck_item=="0"?"巡查对象":"巡查点";
    $('#CK_ITEM_auto').val(DSE.app.ck_item);
    //初始化查询
    DSE.form.doReset();
});