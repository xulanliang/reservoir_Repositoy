...
require_js('wrchkredchildSearch', 'pages/app/sgxc/jlcx/quesList/js/quesListSearch', ['eform']);
require_js('wrchkredchildDatagrid', 'pages/app/sgxc/jlcx/quesList/js/quesListDatagrid', ['wrchkredchildSearch', 'datagrid_pager']);
require_shim('stylePage', ['wrchkredchildDatagrid']);

//执行配置
require.config(DSE.requireConfig);
define('quesListMain', function (require, exports, module) {
