...
require_js('wrchkredchildSearch', 'pages/app/sgxc/jlcx/checkPoints/js/checkPointsSearch', ['eform']);
require_js('wrchkredchildDatagrid', 'pages/app/sgxc/jlcx/checkPoints/js/checkPointsDatagrid', ['wrchkredchildSearch', 'datagrid_pager']);
require_shim('stylePage', ['wrchkredchildDatagrid']);

//执行配置
require.config(DSE.requireConfig);
define('checkPointsMain', function (require, exports, module) {
