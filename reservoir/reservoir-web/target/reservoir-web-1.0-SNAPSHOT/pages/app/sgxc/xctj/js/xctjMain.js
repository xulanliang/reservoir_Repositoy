...
require_js('wrchkobject_search', 'pages/app/sgxc/xctj/js/xctjSearch', ['eform']);
require_js('wrchkobject_datagrid', 'pages/app/sgxc/xctj/js/xctjDatagrid', ['wrchkobject_search', 'datagrid_pager']);
require_shim('stylePage', ['wrchkobject_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('xctjMain', function (require, exports, module) {
    ...
    DSE.app = new Vue({
        ...
        methods: {
            ...
            doBatchDelete: function () {
                ...
                DSE.form.deleteDatagridRow('所选数据', 'wrchkobjectCtrl/deleteXcnrInfoByIds.do', {status: false});
            },
            //查询
            doSearch: function () {
                DSE.form.doSearch();
            ...
            doReset: function () {
                ...
                $('#sTime_auto').val(DSE.app.minDate );
                DSE.app.maxDate = getAddDate(0,new Date());
                $('#eTime_auto').val(DSE.app.maxDate );
                DSE.form.doReset();
            }
        }
    }).$mount('#app');
