...
DSE.form.initDatagrid =function initDatagrid(params, _data) {
    ...
    var _keyId = 'WR_RB_ID',//主键ID,根据业务修改,删除也是用的此字段
   　 _tm='TM',
        _url = DSE.serverPath + '/sljcsjController/searchJcdmCdList.do', //数据请求地址
    //可以删除或注释
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function (value, rowData, rowIndex) {
                    ...
                    op += '<a href="javascript:" class="f-mr10" onclick="DSE.form.showEditOrDetail(\'' + rowData[_keyId] + '\',\'监测断面与测点映射编辑\',\'edit\',\'./addOrEdit/addOrEdit.html\')"><i class="fa fa-edit"></i> 编辑</a>';
                    op += '<a href="javascript:" onclick="DSE.form.deleteDatagridRow(\'所选数据\', \'/sljcsjController/deleteJcdmCd.do\', {ids:\'' + rowData[_keyId]+'\'})"><i class="fa fa-trash-o"></i> 删除</a>';
                    op += '</div>';
                    return op;
                }
            }
