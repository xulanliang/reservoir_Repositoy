...
DSE.form.initDatagrid =function initDatagrid(params, _data) {
   ...
   　 _tm='TM',
        _url = DSE.serverPath + '/sljcsjController/searchSljcsjList.do', //数据请求地址
    //可以删除或注释
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function (value, rowData, rowIndex) {
                    ...
                    op += '<a href="javascript:" class="f-mr10" onclick="DSE.form.showEditOrDetail(\'' + rowData[_keyId] +"tm"+rowData[_tm]+ '\',\'渗流监测数据编辑\',\'edit\',\'./addOrEdit/addOrEdit.html\')"><i class="fa fa-edit"></i> 编辑</a>';
                    op += '<a href="javascript:" onclick="DSE.form.deleteDatagridRow(\'所选数据\', \'/sljcsjController/deleteSljcsj.do\', {ids:\'' + rowData[_keyId]+"tm" + rowData[_tm]+'\'})"><i class="fa fa-trash-o"></i> 删除</a>';
                    op += '</div>';
                    return op;
                }
            }
