...
require_js('shuiwei_search', 'pages/app/zxjc/js/comm_search', ['eform']);
require_js('shuiwei_datagrid', 'pages/app/zxjc/shuiwei/js/shuiweidatagrid', ['shuiwei_search', 'datagrid_pager']);
require_js('comm_echarts', 'pages/app/common/js/comm_echarts', ['echarts3']);
require_shim('stylePage', ['shuiwei_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('shuiweimain', function(require, exports, module) {
    ...
    DSE.form.echarsBean.title_text='水位过程线';
