...
require_js('czwy_search', 'pages/app/zxjc/js/comm_search', ['eform']);
...
define('czwymain', function(require, exports, module) {
    ...
    var Vue = require('vue'),
        ...
        czwy_datagrid = require('czwy_datagrid'),
        date = require('date'),
    ...
    //$("#txt_picker").html('<i class="el-input__icon el-icon-date"></i><input type="text" placeholder="选择日期范围" value="'+DSE.app.minDate+'-'+DSE.app.maxDate+'" autocomplete="off" class="el-input__inner">');
    //alert($("#txt_picker").html() );
    //console.log(' log,html:'+$("#txt_picker").find("input[class='el-input__inner']").html());
    //$("#txt_picker").find("input[class='el-input__inner']").get(0).val(DSE.app.minDate+'-'+DSE.app.maxDate);
    console.log('DSE.app.dateVal>>>>'+DSE.app.dateVal);
    //初始化查询
    DSE.form.doReset();
...
/////////////////////////////////  ex5 begin //////////////////////////////
    ...
    DSE.form.echarsBean.title_text='垂直位移过程线';
