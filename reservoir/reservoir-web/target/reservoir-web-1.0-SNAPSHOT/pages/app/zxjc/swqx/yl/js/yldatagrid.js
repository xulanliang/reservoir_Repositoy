...
DSE.form.initDatagrid = function(params, _data) {
    ...
    var _keyId = 'STCD', //主键ID,根据业务修改,删除也是用的此字段
        _url = DSE.serverPath + '/swqxCtrl/getYlDate.do', //数据请求地址
...
function calcEchars(stcdids){
    //'&projcd='+projcd
    var jsonurl=DSE.baseUrl + '/swqxCtrl/getGcxYlDate.do?stcdids='+stcdids+'&stm='+ DSE.app.minDate
        +'&etm='+DSE.app.maxDate+'&projcd='+DSE.app.projcd+'&keyword='+DSE.app.keyword;
    //生成当前Chart
    createChart(stcdids,DSE.form.echarsBean,jsonurl,'bar',0.3,0.5);
    /*
