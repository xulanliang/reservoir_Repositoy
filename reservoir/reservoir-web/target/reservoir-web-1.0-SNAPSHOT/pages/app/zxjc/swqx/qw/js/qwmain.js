...
require_js('qw_search', 'pages/app/zxjc/swqx/qw/js/qwsearch', ['eform']);
require_js('qw_datagrid', 'pages/app/zxjc/swqx/qw/js/qwdatagrid', ['qw_search', 'datagrid_pager']);
require_js('comm_echarts', 'pages/app/common/js/comm_echarts', ['echarts3']);
require_shim('stylePage', ['qw_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('qwmain', function(require, exports, module) {
    ...
    DSE.form.echarsBean.title_text='温度过程线';
    DSE.form.echarsBean.title_subtext='温度(℃)';
