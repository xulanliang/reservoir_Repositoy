...
require_js('sw_search', 'pages/app/zxjc/swqx/sw/js/swsearch', ['eform']);
require_js('sw_datagrid', 'pages/app/zxjc/swqx/sw/js/swdatagrid', ['sw_search', 'datagrid_pager']);
require_js('comm_echarts', 'pages/app/common/js/comm_echarts', ['echarts3']);
require_shim('stylePage', ['sw_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('swmain', function(require, exports, module) {
    ...
    DSE.form.echarsBean.title_text='水位线';
    DSE.form.echarsBean.title_subtext='水位(m)';
    DSE.form.echarsBean.xaxis_title='日期';
    DSE.form.echarsBean.yaxis_formatter_value='{value} m';
    DSE.form.echarsBean.yaxis_min=20;
    DSE.form.echarsBean.yaxis_max=60;
