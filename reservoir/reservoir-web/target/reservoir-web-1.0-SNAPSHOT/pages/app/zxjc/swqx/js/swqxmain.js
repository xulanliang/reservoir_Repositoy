...
require_js('swqx_search', 'pages/app/zxjc/swqx/js/swqxsearch', ['eform']);
require_js('swqx_datagrid', 'pages/app/zxjc/swqx/js/swqxdatagrid', ['swqx_search', 'datagrid_pager']);
require_shim('stylePage', ['swqx_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('swqxmain', function(require, exports, module) {
