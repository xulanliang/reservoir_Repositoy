...
require_js('yl_search', 'pages/app/zxjc/swqx/yl/js/ylsearch', ['eform']);
require_js('yl_datagrid', 'pages/app/zxjc/swqx/yl/js/yldatagrid', ['yl_search', 'datagrid_pager']);
require_js('comm_echarts', 'pages/app/common/js/comm_echarts', ['echarts3']);
require_shim('stylePage', ['yl_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('ylmain', function(require, exports, module) {
    ...
    // var datagridH=$(".m-datagrid").outerHeight(true);
    // var chartH=winH-searchH-datagridH;
    // $("#ex_0").css("height",chartH+"px");
