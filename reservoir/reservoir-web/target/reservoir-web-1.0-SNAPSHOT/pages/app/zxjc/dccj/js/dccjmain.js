...
require_js('dccj_search', 'pages/app/zxjc/js/comm_search', ['eform']);
require_js('dccj_datagrid', 'pages/app/zxjc/dccj/js/dccjdatagrid', ['dccj_search', 'datagrid_pager']);
require_js('comm_echarts', 'pages/app/common/js/comm_echarts', ['echarts3']);
require_shim('stylePage', ['dccj_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('dccjmain', function(require, exports, module) {
    ...
    DSE.form.echarsBean.title_text='渡槽沉降过程线';
    DSE.form.echarsBean.title_subtext='位移量(mm)';
