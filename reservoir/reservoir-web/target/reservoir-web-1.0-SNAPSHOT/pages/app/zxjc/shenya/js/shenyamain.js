...
require_js('shenya_search', 'pages/app/zxjc/js/comm_search', ['eform']);
require_js('shenya_datagrid', 'pages/app/zxjc/shenya/js/shenyadatagrid', ['shenya_search', 'datagrid_pager']);
require_js('comm_echarts', 'pages/app/common/js/comm_echarts', ['echarts3']);
require_shim('stylePage', ['shenya_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('shenyamain', function(require, exports, module) {
    ...
    DSE.form.echarsBean.title_text='渗压过程线';
    DSE.form.echarsBean.title_subtext='渗压(m)';
