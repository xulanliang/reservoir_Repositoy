...
require_js('scwy_search', 'pages/app/zxjc/js/comm_search', ['eform']);
require_js('scwy_datagrid', 'pages/app/zxjc/scwy/js/scwydatagrid', ['scwy_search', 'datagrid_pager']);
require_js('comm_echarts', 'pages/app/common/js/comm_echarts', ['echarts3']);
require_shim('stylePage', ['scwy_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('scwymain', function(require, exports, module) {
    ...
    DSE.form.echarsBean.title_text='深层位移过程线';
