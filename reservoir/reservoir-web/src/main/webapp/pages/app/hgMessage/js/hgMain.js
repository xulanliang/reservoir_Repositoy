...
//
require_js('wzcfdxx_search', 'pages/app/hgMessage/js/hgDatagrid', ['eform','oper_config']);
require_js('wzcfdxx_datagrid','pages/app/hgMessage/js/hgSearch', ['wzcfdxx_search', 'datagrid_pager']);
require_shim('stylePage', ['wzcfdxx_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('hgMain', function (require, exports, module) {
