...
require_js('wralarmparamm_search', 'pages/app/sjfx/wralarmparamm/js/wralarmparammSearch', ['eform']);
require_js('wralarmparamm_datagrid', 'pages/app/sjfx/wralarmparamm/js/wralarmparammDatagrid', ['wralarmparamm_search', 'datagrid_pager']);
require_shim('stylePage', ['wralarmparamm_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('wralarmparammMain', function (require, exports, module) {
    var _stylePage = require('stylePage');

    //引入 Vue + ElementUI
    var Vue = require('vue'),
        vue_component = require('vue_component'),
        wralarmparamm_search = require('wralarmparamm_search'),
    ...
    DSE.app = new Vue({
        ...
        methods: {
            ...
            doOpenEdit: function () {
                 ...
                 *根据业务需求修改
                 * */
               // $(DSE.form.datagrid).datagrid('beginEdit', 0);
               // $(DSE.form.datagrid).datagrid('endEdit', 10);
               // console.log('beginEdit  endEdit '+111111111111);
                $(DSE.form.datagrid).datagrid({
