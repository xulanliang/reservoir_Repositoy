...
DSE.form.initDatagrid = function(params, _data) {
    ...
    var _keyId = 'ID', //主键ID,根据业务修改,删除也是用的此字段
        _url = DSE.serverPath + '/shenLiuCtrl/getBaseDataList.do', //数据请求地址
    ...
    function getUrl(){
        ...
        if(type == 1){
            ...
            return DSE.serverPath + '/shenLiuCtrl/getCountDataList.do';
        }
        return _url;
    }
    ...
    function getColumns(){
        ...
        $.ajax({
            ...
            success: function(data) {
                var length=0;
                if(data.data!==undefined && typeof(data.data)!==undefined && data.data!=null){
