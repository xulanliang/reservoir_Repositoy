...
require_js('dnpjtzz_search', 'pages/app/sjfx/szsk/spwy/dnpjtzz/js/dnpjtzzsearch', ['eform']);
require_js('dnpjtzz_datagrid', 'pages/app/sjfx/szsk/spwy/dnpjtzz/js/dnpjtzzdatagrid', ['dnpjtzz_search', 'datagrid_pager']);
            ...
            doExport: function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        // window.location.href = decodeURI(DSE.serverPath + '/excelController/downExcel.do?exportId=' + data.data + '&shortName=水平位移-多年平均特征值.xlsx');
                        var shortName='水平位移-多年平均特征值.xlsx';
