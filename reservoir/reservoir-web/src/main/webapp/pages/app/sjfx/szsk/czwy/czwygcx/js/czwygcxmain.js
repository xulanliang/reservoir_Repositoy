...
require_js('czwygcx_search', 'pages/app/common/js/comm_gcxsearch', ['eform']);
    ...
    DSE.app = new Vue({
        ...
        methods: {
            ...
            doReset: function() {
                ...
                */
                var jsonurl=DSE.baseUrl + '/gcxCtrl/getCzwyGcxChartData.do?stm='+ this.minDate+'&etm='+this.maxDate+'&wrrbm_rbcd='+this.wrrbm_rbcd+'&projcd='+this.projcd;
