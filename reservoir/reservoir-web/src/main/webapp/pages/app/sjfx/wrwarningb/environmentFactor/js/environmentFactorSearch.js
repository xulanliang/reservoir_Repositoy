...
/*
    ...
    $(strDate).datebox({
        ...
        onSelect: function (rec) {
            vDateToSelect(strDate, endDate, 1);
    ...
    $(endDate).datebox({
        ...
        editable: false,
        onSelect: function (rec) {
            vDateToSelect(strDate, endDate, 2);
        }
    });
*/

    /*var nDate = getCurentDate();
    $(strDate).datebox('setValue',getAddDate(-30,nDate));
    $(endDate).datebox('setValue',nDate);*/
