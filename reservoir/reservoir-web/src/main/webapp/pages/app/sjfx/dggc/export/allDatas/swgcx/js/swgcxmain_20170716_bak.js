...
require_js('swgcx_search', 'pages/app/sjfx/dggc/shuiwei/swgcx/js/swgcxsearch', ['eform']);
        ...
        methods: {
            ...
            doReset: function() {
               ...
               // DSE.form.doReset();
                ...
                var jsonurl=DSE.baseUrl + '/gcxCtrl/getSwGcxChartData.do?t='+t.getMilliseconds()+'&stm='+ this.minDate+'&etm='+this.maxDate+'&wrprojb_proj_cd='+this.wrprojb_proj_cd+'&projcd='+projcd;
