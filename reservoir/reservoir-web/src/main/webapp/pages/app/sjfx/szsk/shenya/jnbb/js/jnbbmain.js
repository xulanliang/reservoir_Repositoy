...
require_js('jnbb_search', 'pages/app/sjfx/szsk/shenya/jnbb/js/jnbbsearch', ['eform']);
require_js('jnbb_datagrid', 'pages/app/sjfx/szsk/shenya/jnbb/js/jnbbdatagrid', ['jnbb_search', 'datagrid_pager']);
    ...
    DSE.app = new Vue({
        ...
        methods: {
            ...
            doExport: function () {
                ...
                var url= DSE.serverPath + '/shenyaCtrl/exportSZSKJnbbExcel.do?' +searchData +'&queryType=szsk'+ '&rows='+rows + '&fileName='+encodeURIComponent(encodeURIComponent(fileName));
                window.location.href = url ;

               /* var exportType = '渗压-季年报表';
                $.ajax({
                    url: DSE.serverPath + '/shenyaCtrl/getjnbbList.do',
                    async: false,
                    data: {
