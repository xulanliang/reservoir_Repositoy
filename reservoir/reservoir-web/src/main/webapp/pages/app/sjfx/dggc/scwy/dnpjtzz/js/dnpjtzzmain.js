...
require_js('dnpjtzz_search', 'pages/app/sjfx/dggc/scwy/dnpjtzz/js/dnpjtzzsearch', ['eform']);
require_js('dnpjtzz_datagrid', 'pages/app/sjfx/dggc/scwy/dnpjtzz/js/dnpjtzzdatagrid', ['dnpjtzz_search', 'datagrid_pager']);
...
define('dnpjtzzmain', function(require, exports, module) {
    ...
    DSE.app = new Vue({
        ...
        methods: {
            ...
            //导出
            doExport: function () {
                var exportType = '深层位移-多年平均特征值';
                $.ajax({
                    url: DSE.serverPath + '/scwyCtrl/getDnpjtzzList.do',
                    async: false,
                    data: {
                    ...
                    success: function (data) {
                        $.ajax({
                            ...
                            type: 'post',
                            success: function (data) {
                                //window.location.href = decodeURI(DSE.serverPath + '/excelController/downExcel.do?exportId=' + data.data + '&shortName=深层位移-多年平均特征值.xlsx');
                                var shortName='深层位移-多年平均特征值.xlsx';
