...
require_js('jnbb_search', 'pages/app/sjfx/dggc/shuiwei/jnbb/js/jnbbsearch', ['eform']);
require_js('jnbb_datagrid', 'pages/app/sjfx/dggc/shuiwei/jnbb/js/jnbbdatagrid', ['jnbb_search', 'datagrid_pager']);
    ...
    DSE.app = new Vue({
        ...
        methods: {
            ...
            doExport: function () {
                ...
                var url= DSE.serverPath + '/shuiweiCtrl/exportJnbbExcel.do?' +searchData + '&rows='+rows  + '&fileName='+encodeURIComponent(encodeURIComponent(fileName));
