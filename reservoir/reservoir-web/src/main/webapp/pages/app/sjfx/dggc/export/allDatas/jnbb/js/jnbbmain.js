...
require_js('jnbb_search', 'pages/app/sjfx/dggc/export/allDatas/jnbb/js/jnbbsearch', ['eform']);
require_js('jnbb_datagrid', 'pages/app/sjfx/dggc/export/allDatas/jnbb/js/jnbbdatagrid', ['jnbb_search', 'datagrid_pager']);
    ...
    DSE.app = new Vue({
        ...
        methods: {
            ...
            doExport: function () {
                ...
                var url= DSE.serverPath + '/dggcAllDataCtr/exportJnbbExcel.do?' +searchData + '&rows='+rows  + '&fileName='+encodeURIComponent(encodeURIComponent(fileName));
                window.location.href = url ;
                /*var exportType = '水位-季年报表';
                $.ajax({
                    url: DSE.serverPath + '/shuiweiCtrl/getjnbbList.do',
                    async: false,
                    data: {
                    ...
                    success: function (data) {
                        $.ajax({
                            ...
                            type: 'post',
                            success: function (data) {
                                //window.location.href = decodeURI(DSE.serverPath + '/excelController/downExcel.do?exportId=' + data.data + '&shortName=水位-季年报表.xlsx');
                                var shortName='水位-季年报表.xlsx';
