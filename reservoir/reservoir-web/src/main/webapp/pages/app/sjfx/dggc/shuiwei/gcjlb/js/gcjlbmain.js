...
require_css('css!pages/app/sjfx/dggc/shuiwei/gcjlb/css/gcjlbPage.css');

require_js('gcjlb_search', 'pages/app/sjfx/dggc/shuiwei/gcjlb/js/gcjlbsearch', ['eform']);
require_js('gcjlb_datagrid', 'pages/app/sjfx/dggc/shuiwei/gcjlb/js/gcjlbdatagrid', ['gcjlb_search', 'datagrid_pager']);
    ...
    DSE.app = new Vue({
        ...
        methods: {
            ...
            doExport: function() {
                ...
                var url= DSE.serverPath + '/shuiweiCtrl/exportGcjlbExcel.do?' +searchData+'&pointType=1' + '&rows='+rows + '&fileName='+encodeURIComponent(encodeURIComponent(fileName));
