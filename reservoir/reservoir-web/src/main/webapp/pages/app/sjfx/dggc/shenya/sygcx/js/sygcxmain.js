...
require_js('sygcx_search', 'pages/app/sjfx/dggc/js/comm_dggc_gcxsearch', ['eform']);
        ...
        methods: {
            ...
            doReset: function() {
               ...
               // DSE.form.doReset();
                ...
                var jsonurl=DSE.baseUrl + '/gcxCtrl/getSyGcxChartData.do?stm='+ this.minDate+'&etm='+this.maxDate+'&wrrbm_rbcd='+this.wrrbm_rbcd+'&projcd='+this.projcd;
