...
require_js('gcx_search', 'pages/app/sjfx/szsk/swqx/gcx/js/gcxsearch', ['eform']);
...
define('gcxmain', function(require, exports, module) {
    ...
    DSE.app = new Vue({
        ...
        methods: {
            ...
            changeChkVal: function(vid) {
                $("#ex_"+vid).toggle();
                DSE.app.vid=!DSE.app.vid;
                 if(vid=="qw_auto"){
                     console.log(' DSE.app.qw_auto: '+DSE.app.qw_auto);
                     DSE.app.qw_auto=!DSE.app.qw_auto;
                     if(echarsbean_wd!=null){
                         var  curecharts_wd=create_echarts_single(echarts,echarsbean_wd,true);
                     }
                 }else if(vid=="jy_auto"){
                     console.log(' DSE.app.jy_auto: '+DSE.app.jy_auto);
                     DSE.app.jy_auto=!DSE.app.jy_auto;
                     if(echarsbean_qy!=null){
                         var  curecharts_qy=create_echarts_single(echarts,echarsbean_qy,true);
                     }
                 }
            },
            //关闭
            ...
            //////
                ...
                var jsonurl=DSE.baseUrl + '/gcxCtrl/getQxGcxChartData.do?stm='+ this.minDate+'&etm='+this.maxDate+'&projcd='+this.projcd;
                ...
                $.getJSON(jsonurl,function(resultData){
                    ...
                    if(echarsbean1.series_datas){
                        ...
                        echarsbean1.yaxis_max= parseFloat(getMaximin(tempDataStr,"max"));
                    ...
                    //console.log(' echarsbean.yaxis_max222: '+echarsbean_qy.yaxis_max+' echarsbean.yaxis_min222:'+echarsbean_qy.yaxis_min);
                    if(echarsbean_qy!=null){
                        var  curecharts_qy=create_echarts_single(echarts,echarsbean_qy,true);
                    }
                    /////////////////////////////////  ex4 end //////////////////////////////
    ...
    $("#ex_qw_auto").hide();
    $("#ex_jy_auto").hide();
     $("#qw_auto").prop("checked","");
     $("#jy_auto").prop("checked","");
