...
//
require_js('wzcfdxx_search', 'pages/app/tableEdit/sksqb/js/sksqbDatagrid', ['eform','oper_config']);
require_js('wzcfdxx_datagrid', 'pages/app/tableEdit/sksqb/js/sksqbSearch', ['wzcfdxx_search', 'datagrid_pager']);
require_shim('stylePage', ['wzcfdxx_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('sksqbMain', function (require, exports, module) {
    var _stylePage = require('stylePage');
    var _date97 = require('date97');
    var _date9 = require('date');
