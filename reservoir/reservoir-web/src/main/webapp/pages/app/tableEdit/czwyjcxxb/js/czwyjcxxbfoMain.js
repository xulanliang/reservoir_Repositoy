...
//
require_js('wzcfdxx_search', 'pages/app/tableEdit/czwyjcxxb/js/czwyjcxxbDatagrid', ['eform','oper_config']);
require_js('wzcfdxx_datagrid', 'pages/app/tableEdit/czwyjcxxb/js/czwyjcxxbSearch', ['wzcfdxx_search', 'datagrid_pager']);
require_shim('stylePage', ['wzcfdxx_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('czwyjcxxbfoMain', function (require, exports, module) {
    var _stylePage = require('stylePage');
    var _date97 = require('date97'),
        _date = require('date'),
        _oper_config = require('oper_config');
