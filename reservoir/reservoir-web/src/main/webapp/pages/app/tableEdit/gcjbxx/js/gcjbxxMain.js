...
//
require_js('wzcfdxx_search', 'pages/app/tableEdit/gcjbxx/js/gcjbxxDatagrid', ['eform','oper_config']);
require_js('wzcfdxx_datagrid', 'pages/app/tableEdit/gcjbxx/js/gcjbxxSearch', ['wzcfdxx_search', 'datagrid_pager']);
require_shim('stylePage', ['wzcfdxx_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('gcjbxxMain', function (require, exports, module) {
