...
//
require_js('shenyaParam_search', 'pages/app/tableEdit/shenyaSatatsParamInfo/js/shenyaStatsParamSearch', ['eform','oper_config']);
require_js('shenyaParam_datagrid', 'pages/app/tableEdit/shenyaSatatsParamInfo/js/shenyaStatsParamDatagrid', ['shenyaParam_search', 'datagrid_pager']);
require_shim('stylePage', ['shenyaParam_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('shenyaStatsParamMain', function (require, exports, module) {
