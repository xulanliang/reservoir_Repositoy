...
DSE.form.initDatagrid =function initDatagrid(params, _data) {
    ...
    var _keyId = 'ITEM_CD', //主键ID,根据业务修改,删除也是用的此字段
        tm='TM',
        _url = DSE.serverPath + '/tableEditCtrl/getProjectBaseListInfoByParams.do', //数据请求地址
            ...
            },
            {
                ...
                formatter:function (value, rowData, rowIndex) {
                    switch (parseInt(value)){
                        case 1:return "渗压";break;
                        case 2:return "渗流";break;
                        case 3:return "水平位移";break;
                        case 4:return "垂直位移";break;
                        case 5:return "水位";break;
                        case 6:return "雨量";break;
                        case 7:return "气温";break;
                        case 8:return "深层位移";break;
                        case 9:return "渡槽沉降";break;
                    }
                }
            }, {
                field: 'NOT_SINGLE',
                ...
                formatter:function (value, rowData, rowIndex) {
                    switch (parseInt(value)){
                        case 1:return "自动化监测";break;
                        case 0:return "非自动化监测";break;
                    }
                }
            }, {
                field: 'TS',
                ...
                formatter: function (value, rowData, rowIndex) {
                    ...
                    op += '<a href="javascript:" class="f-mr10" onclick="DSE.form.showEditOrDetail(\'' + rowData[_keyId] + '\',\'编辑监测项目基本信息\',\'edit\',\'./addOrEdit/addOrEdit.html\')"><i class="fa fa-edit"></i> 编辑</a>';
