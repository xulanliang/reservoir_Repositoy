...
require_js('wrmawarningb_search', 'pages/app/fxwz/js/comm_fxwzSearch', ['eform']);
require_js('wrmawarningb_datagrid', 'pages/app/fxwz/wrmawarningb/js/wrmawarningbDatagrid', ['wrmawarningb_search', 'datagrid_pager']);
require_shim('stylePage', ['wrmawarningb_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('wrmawarningbMain', function (require, exports, module) {
