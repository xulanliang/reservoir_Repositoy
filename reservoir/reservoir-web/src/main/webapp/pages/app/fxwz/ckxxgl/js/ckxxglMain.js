...
require_js('ckxxgl_search', 'pages/app/fxwz/ckxxgl/js/ckxxglSearch', ['eform']);
require_js('ckxxgl_datagrid', 'pages/app/fxwz/ckxxgl/js/ckxxglDatagrid', ['ckxxgl_search', 'datagrid_pager']);
require_shim('stylePage', ['ckxxgl_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('ckxxglMain', function (require, exports, module) {
    ...
    DSE.app = new Vue({
        ...
        methods: {
            ...
            doBatchDelete: function () {
                ...
                DSE.form.deleteDatagridRow('所选数据', 'ckxxglCtrl/deleteInfoByIds.do', {status: false});
            },
            //查询
            doSearch: function () {
                DSE.form.doSearch();
