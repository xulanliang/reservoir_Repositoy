...
require_js('wzxxgl_search', 'pages/app/fxwz/wzxxgl/js/wzxxglSearch', ['eform']);
require_js('wzxxgl_datagrid', 'pages/app/fxwz/wzxxgl/js/wzxxglDatagrid', ['wzxxgl_search', 'datagrid_pager']);
require_shim('stylePage', ['wzxxgl_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('wzxxglMain', function (require, exports, module) {
        ...
        methods: {
            ...
            doOpenWin: function () {
               ...
               // }
                ...
                //console.log('DSE.app.ma_cds： '+this.ma_cds);
                if (nullToSpace(this.ma_cds) == '') {
                    ...
                    this.title = '物资添加到仓库';
                    //if (this.url === '') {
                        this.url = './addwz2ck/addOrEdit.html?ma_cds='+this.ma_cds+'&ma_nms='+this.ma_nms+'&gs_std_quans='+this.gs_std_quans;
                    //}
                }
            },
            //关闭
