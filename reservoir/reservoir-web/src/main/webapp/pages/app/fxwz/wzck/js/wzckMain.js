...
require_js('wzflgl_search', 'pages/app/fxwz/wzck/js/wzckSearch', ['eform']);
require_js('wzflgl_datagrid', 'pages/app/fxwz/wzck/js/wzckDatagrid', ['wzflgl_search', 'datagrid_pager']);
require_shim('stylePage', ['wzflgl_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('wzckMain', function (require, exports, module) {
