...
require_js('wrmaquanbSearch', 'pages/app/fxwz/wrmaquanb/js/wrmaquanbSearch', ['eform']);
require_js('wrmaquanbDatagrid', 'pages/app/fxwz/wrmaquanb/js/wrmaquanbDatagrid', ['wrmaquanbSearch', 'datagrid_pager']);
require_shim('stylePage', ['wrmaquanbDatagrid']);

//执行配置
require.config(DSE.requireConfig);
define('wrmaquanbMain', function (require, exports, module) {
    var _stylePage = require('stylePage');

    //引入 Vue + ElementUI
    var Vue = require('vue'),
        vue_component = require('vue_component'),
        wrmaquanbSearch = require('wrmaquanbSearch'),
    ...
    DSE.app = new Vue({
        data: function () {
            return {
                ...
                wr_ma_inventory_id:$.getParam("wr_ma_inventory_id"),//
        ...
        methods: {
            ...
            doParentCloseWin: function() {
                // 父窗口调用方法刷新
                console.log(' parent.DSE.form.refreshDatagrid: '+parent.DSE.form.refreshDatagrid);
            ...
            doOpenWin: function () {
                ...
                this.title = '新增库存余量信息';
                //if (this.url === '') {
                    this.url = './addOrEdit/addOrEdit.html?ma_cd='+DSE.app.ma_cd+'&wh_cd='+DSE.app.wh_cd+'&ma_nm='+DSE.app.ma_nm+'&wh_nm='+DSE.app.wh_nm;
                //}
            ...
            doBatchDelete: function () {
                ...
                DSE.form.deleteDatagridRow('所选数据', 'wzkzglCtrl/deleteInfoByIds.do', {status: false});
            },
            //查询
            doSearch: function () {
                DSE.form.doSearch();
