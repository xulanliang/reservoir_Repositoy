...
//
require_js('wzcfdxx_search', 'pages/app/dccjjc/js/datagrid', ['eform','oper_config']);
require_js('wzcfdxx_datagrid','pages/app/dccjjc/js/search', ['wzcfdxx_search', 'datagrid_pager']);
