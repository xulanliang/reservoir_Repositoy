...
//
require_js('wzcfdxx_search', 'pages/app/sljcsj/js/datagrid', ['eform','oper_config']);
require_js('wzcfdxx_datagrid','pages/app/sljcsj/js/search', ['wzcfdxx_search', 'datagrid_pager']);
