...
require_js('wrchkrecord_datagrid', 'pages/app/sgxc/wrchkrecord/js/wrchkrecordDatagrid', ['comm_sgxcSearch', 'datagrid_pager']);
require_shim('stylePage', ['wrchkrecord_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('wrchkrecordMain', function (require, exports, module) {
        ...
        methods: {
            ...
            doOpenWin: function () {
                ...
                if (nullToSpace(DSE.app.ck_obj_id) == '') {
                     $tips.err('请在巡查对象树上选择一个对象节点,再进行巡查任务新增操作！');
                ...
                this.title = '新增巡查任务信息';
                //if (this.url === '') {
                    this.url = "./addOrEdit/addOrEdit.html?ck_re_id=''&ck_obj_id="+DSE.app.ck_obj_id;
                //}
            },
            //关闭
            doCloseWin: function () {
            ...
            doBatchDelete: function () {
                ...
                DSE.form.deleteDatagridRow('所选数据', 'wrchkRecordCtrl/deleteInfoByIds.do', {status: false});
            },
            //查询
            doSearch: function () {
                DSE.form.doSearch();
