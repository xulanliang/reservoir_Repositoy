...
require_css('css!pages/app/sgxc/wrchkredchild/css/wrchkredchildDatagrid.css');

require_js('wrchkredchildSearch', 'pages/app/sgxc/wrchkredchild/js/wrchkredchildSearch', ['eform']);
require_js('wrchkredchildDatagrid', 'pages/app/sgxc/wrchkredchild/js/wrchkredchildDatagrid', ['wrchkredchildSearch', 'datagrid_pager']);
require_shim('stylePage', ['wrchkredchildDatagrid']);

//执行配置
require.config(DSE.requireConfig);
define('wrchkredchildMain', function (require, exports, module) {
