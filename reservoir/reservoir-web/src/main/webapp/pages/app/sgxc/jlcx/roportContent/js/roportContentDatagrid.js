...
DSE.form.initDatagrid = function(params, _data) {
    ...
    var datagridOptions = {
        ...
        //        //执行保存方法
        //        $ajax({
        //            url: DSE.serverPath + 'xcsbCtrl/saveXcsb.do',
        //            async: true,
        //            data: {
        //                ckID: row.ID,
        //                issue:row.ISU_DESC,
        ...
        columns: [
            [{
                ...
                //    //链接查看详情
                //    return '<a href="javascript:" class="f-link3" onclick="DSE.form.showEditOrDetail(\'' + rowData[_keyId] + '\',\'巡查记录项目信息\',\'detail\',\'../../xcnr/xcnr.html?ID='+rowData[_keyId]+'\')">' + nullToSpace(value) + '</a>';
                //}
            },{
                field: 'CK_CNT_DESC',
                title: '巡查内容描述',
