...
require_js('wrchkobject_search', 'pages/app/sgxc/xcnr/js/xcnrSearch', ['eform']);
require_js('wrchkobject_datagrid', 'pages/app/sgxc/xcnr/js/xcnrDatagrid', ['wrchkobject_search', 'datagrid_pager']);
require_shim('stylePage', ['wrchkobject_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('xcnrMain', function (require, exports, module) {
