...
//
require_js('wzcfdxx_search', 'pages/app/jcdmycd/js/datagrid', ['eform','oper_config']);
require_js('wzcfdxx_datagrid','pages/app/jcdmycd/js/search', ['wzcfdxx_search', 'datagrid_pager']);
