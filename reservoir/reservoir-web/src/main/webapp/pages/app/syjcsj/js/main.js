...
//
require_js('wzcfdxx_search', 'pages/app/syjcsj/js/datagrid', ['eform','oper_config']);
require_js('wzcfdxx_datagrid','pages/app/syjcsj/js/search', ['wzcfdxx_search', 'datagrid_pager']);
