...
require_js('singletable_search', 'pages/app/demos/singletable/js/search', ['eform']);
require_js('singletable_datagrid', 'pages/app/demos/singletable/js/datagrid', ['singletable_search', 'datagrid_pager']);
