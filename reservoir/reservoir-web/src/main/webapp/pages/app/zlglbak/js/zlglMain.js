...
define('zlglMain', function (require, exports, module) {
    ...
    $(adcd).tree({
        ...
        onLoadSuccess: function () {
            // app.adcd = divisionCodes;
            // var node = $(adcd).tree('find', divisionCodes);
            $(adcd).tree('collapseAll');
            // $(adcd).tree('select', node.target);
            // $(adcd).tree('expand', node.target);
        },
