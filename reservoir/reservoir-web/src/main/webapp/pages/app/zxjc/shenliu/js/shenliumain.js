...
require_js('shenliu_search', 'pages/app/zxjc/js/comm_search', ['eform']);
require_js('shenliu_datagrid', 'pages/app/zxjc/shenliu/js/shenliudatagrid', ['shenliu_search', 'datagrid_pager']);
require_js('comm_echarts', 'pages/app/common/js/comm_echarts', ['echarts3']);
require_shim('stylePage', ['shenliu_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('shenliumain', function(require, exports, module) {
    ...
    DSE.form.echarsBean.title_text='渗流过程线';
    DSE.form.echarsBean.title_subtext='渗流(l/s)';
    DSE.form.echarsBean.xaxis_title='日期';
    DSE.form.echarsBean.yaxis_formatter_value='{value} ';
