...
DSE.form.initDatagrid = function(params, _data) {
    ...
    var _keyId = 'STCD', //主键ID,根据业务修改,删除也是用的此字段
        _url = DSE.serverPath + '/swqxCtrl/getQwqyDate.do', //数据请求地址
...
function calcEchars(stcdids){
    var jsonurl=DSE.baseUrl + '/swqxCtrl/getGcxQwqyDate.do?stcdids='+stcdids+'&stm='+ DSE.app.minDate
        +'&etm='+DSE.app.maxDate+'&projcd='+DSE.app.projcd+'&keyword='+DSE.app.keyword;
    //
    createChart_QY(stcdids,DSE.form.echarsBean,jsonurl,'line',0.3,0.5);
/*
