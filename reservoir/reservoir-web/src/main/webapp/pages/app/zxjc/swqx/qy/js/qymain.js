...
require_js('qy_search', 'pages/app/zxjc/swqx/qy/js/qysearch', ['eform']);
require_js('qy_datagrid', 'pages/app/zxjc/swqx/qy/js/qydatagrid', ['qy_search', 'datagrid_pager']);
require_js('comm_echarts', 'pages/app/common/js/comm_echarts', ['echarts3']);
require_shim('stylePage', ['qy_datagrid']);

//执行配置
require.config(DSE.requireConfig);
define('qymain', function(require, exports, module) {
    ...
    DSE.form.echarsBean.title_text='气压线';
    DSE.form.echarsBean.title_subtext='气压(kPa)';
    DSE.form.echarsBean.xaxis_title='日期';
    DSE.form.echarsBean.yaxis_formatter_value='{value} kPa';
