...
//火狐window添加event属性
if(window.__defineGetter__){DSE.FF_EVENT=function(){var c=DSE.FF_EVENT.caller;while(c.caller)c=c.caller;return c.arguments[0]};__defineGetter__("event",DSE.FF_EVENT)};
