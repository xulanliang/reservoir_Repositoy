...
], function (dom, on, declare, Array, domConstruct, string, lang, sniff, Draw, Graphic, Point, GraphicsLayer, geometryEngine, Font, SimpleLineSymbol, SimpleFillSymbol, TextSymbol, PictureMarkerSymbol, SimpleMarkerSymbol, _BaseTool, webMercatorUtils) {
    //
    var drawTool = null;
    var showPt = null;
    //
