...
define(["dojo/_base/declare", "dojo/string", "dojo/_base/array",
    ...
    "../layers/GoogleLocalTiledLayer", "../layers/SuperMapWMTSLayer", "../layers/TdtWMTSLayer"
], function (declare, stringUtils, arrayUtils, BaiDuTiledLayer, WebTiledLayer, FeatureLayer, GraphicsLayer, ArcGISDynamicMapServiceLayer, WFSLayer, ArcGISTiledMapServiceLayer, LocalTiledLayer, lang, GoogleLocalTiledLayer, SuperMapWMTSLayer, TdtWMTSLayer) {
    //
    /**
     * ===========================================
     ...
     * */
    //
    var dxUrl = "http://${subDomain}.google.cn/vt/lyrs=t@132,r@292013572&hl=zh-CN&gl=CN&src=arcgis&expIds=201527&rlbl=1&x=${col}&y=${row}&z=${level}&s=";
    //
    var jtUrl = "http://${subDomain}.google.cn/vt/lyrs=m@297000000&hl=zh-CN&gl=CN&src=arcgis&expIds=201527&rlbl=1&x=${col}&y=${row}&z=${level}&s=";
    //
    ...
    return declare(null, {
         ...
         * */
        //
        loadBaseLayers: function (layersCfg) {
            //
            arrayUtils.forEach(layersCfg, lang.hitch(this, function (cfg) {
                ...
                switch (cfg.type) {
                    ...
                    //加载ArcGIS动态地图服务.
                    case "dynamic":
                        baseLayer = new ArcGISDynamicMapServiceLayer(cfg.url, {
                            //
                            id: cfg.id,
                            visible: cfg.initShow
                        });
                    ...
                    //
                    case "googleOffLine":
                        baseLayer = new GoogleLocalTiledLayer(cfg.url, {
                            //
                            id: cfg.id,
                            visible: cfg.initShow,
                            initExtent: cfg.initExtent,
                        ...
                        if (cfg.labelInfo && cfg.labelInfo.url) {
                            //
                            labelLayer = new GoogleLocalTiledLayer(cfg.labelInfo.url, {
                                id: cfg.id + "w",
                                visible: cfg.initShow,
                                initExtent: cfg.initExtent,
                                fullExtent: cfg.fullExtent,
