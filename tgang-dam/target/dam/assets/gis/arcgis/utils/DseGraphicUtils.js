...
define([
    ...
    "esri/InfoTemplate",
    "dojo/json"
], function (declare, Polygon, Point, Polyline, SpatialReference, dseSymbolUtils, dseGisUtils, Graphic,
             symbolJsonUtils,geometryJsonUtils,InfoTemplate,JSON) {
    //
    ...
    return declare(null,{
         ...
         * @return Graphic
         **/
        createPoint: function (data, lgtd, lttd, imgpath, imgwidth, imgheigth) {
         ...
         * @return Graphic
         **/
        createPoint2:function(data,lgtd,lttd,symbol){
            //
            var dqzb = dseGisUtils.WgsToDqzb(lgtd, lttd,this.mapType);//经纬度转换成当前投影下的坐标，gis_Datacommon
            var p = new Point(dqzb[0], dqzb[1], _map.spatialReference);
