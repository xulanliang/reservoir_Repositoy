...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/dom", "dojo/on", "dojo/topic", "dojo/dom-construct",
        ...
        "./_BaseControl", "../utils/dseGisUtils", "esri/geometry/Extent"],
    function (declare, lang, dom, on, topic, domConstruct, Array, string, regionConfig, _BaseControl, dseGisUtils, Extent) {
            ...
            _navigateToExtent: function (arrExtent) {
                if (arrExtent && arrExtent.length > 3) {
                    ...
                    var extent = new Extent(Number(minEx[0]),
                        ...
                        Number(maxEx[1]), this.map.spatialReference);
