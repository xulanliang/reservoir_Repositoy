var _easyui_valid = function($) {
	...
	$(function() {
		...
		/** 校验提示位置 */
		/*
		 * $.extend($.fn.validatebox.defaults.tipOptions, { onShow : function() {
		 * $(this).tooltip("tip").tooltip({ position : 'left' }); //return
		 * false; } });
		 */
	});
};
...
if (typeof dseDefine === 'function') {
	dseDefine(function(require, exports, module) {
		// require('easyui');
		return _easyui_valid(require('jquery'));
	});
} else {
	// 依赖jquery
	_easyui_valid(jQuery);
}