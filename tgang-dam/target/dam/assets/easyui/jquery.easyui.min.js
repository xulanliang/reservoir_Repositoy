 ...
 */
//jiangfl
;var $_dseBuildEasyui=function(jQuery){
	...
	(function($) {
		$.parser = {
			...
			plugins : [ "draggable", "droppable", "resizable", "pagination", "tooltip", "linkbutton", "menu", "menubutton", "splitbutton",
					"switchbutton", "progressbar", "tree", "textbox", "filebox", "combo", "combobox", "combotree", "combogrid", "numberbox",
					"validatebox", "searchbox", "spinner", "numberspinner", "timespinner", "datetimespinner", "calendar", "datebox", "datetimebox",
	...
	(function($) {
			...
			doLayout : function(jq, all) {
				return jq.each(function() {
					...
					function _25f(_260, type) {
						...
						var s = $(_260).find(
								"div.panel:visible,div.accordion:visible,div.tabs-container:visible,div.layout:visible,.easyui-fluid:visible").filter(
								function(_262, el) {
		...
		$.fn.panel.parseOptions = function(_266) {
			...
			return $.extend({}, $.parser.parseOptions(_266, [ "id", "width", "height", "left", "top", "title", "iconCls", "cls", "headerCls", "bodyCls",
					"tools", "href", "method", "header", "footer", {
						cache : "boolean",
						fit : "boolean",
						border : "boolean",
						noheader : "boolean"
	...
	(function($) {
		...
		function _31b(_31c) {
			...
			if (opts.tools) {
				if (typeof opts.tools == "string") {
					...
					var _31e = $("<div class=\"tabs-tool\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"height:100%\"><tr></tr></table></div>")
							.appendTo(_31d);
					var tr = _31e.find("tr");
		...
		function _31f(_320, _321) {
			...
			if (opts.tabPosition == "left" || opts.tabPosition == "right") {
				...
				_323.children("div.tabs-scroller-left,div.tabs-scroller-right,div.tabs-tool:not(.tabs-tool-hidden)").css("display",
		...
		function _331(_332) {
			...
			$(
					"<div class=\"tabs-header\">" + "<div class=\"tabs-scroller-left\"></div>" + "<div class=\"tabs-scroller-right\"></div>"
							+ "<div class=\"tabs-wrap\">" + "<ul class=\"tabs\"></ul>" + "</div>" + "</div>").prependTo(_332);
		...
		function _340(_341, _342, pp) {
			...
			var tab = $("<li>" + "<a href=\"javascript:void(0)\" class=\"tabs-inner\">" + "<span class=\"tabs-title\"></span>"
	...
	(function($) {
		function init(_4ba) {
			...
			var span = $(
					"<span class=\"textbox\">" + "<input class=\"textbox-text\" autocomplete=\"off\">"
							+ "<input type=\"hidden\" class=\"textbox-value\">" + "</span>").insertAfter(_4ba);
		...
		function _4bb(_4bc) {
			...
			if (bb.length) {
				...
				for ( var i = 0; i < bb.length; i++) {
					bc
							.append("<a href=\"javascript:void(0)\" class=\"textbox-icon " + bb[i].iconCls + "\" icon-index=\"" + i
									+ "\" tabindex=\"-1\"></a>");
				}
			}
		...
		$.fn.textbox.parseOptions = function(_4f4) {
			var t = $(_4f4);
			return $.extend({}, $.fn.validatebox.parseOptions(_4f4), $.parser.parseOptions(_4f4, [ "prompt", "iconCls", "iconAlign", "buttonText",
					"buttonIcon", "buttonAlign", {
						multiline : "boolean",
						editable : "boolean",
						iconWidth : "number"
					} ]), {
	...
	(function($) {
		...
		$.fn.form.defaults = {
			fieldTypes : [ "combobox", "combotree", "combogrid", "datetimebox", "datebox", "combo", "datetimespinner", "timespinner", "numberspinner",
					"spinner", "slider", "searchbox", "numberbox", "textbox", "switchbutton" ],
			novalidate : false,
			ajax : true,
			url : null,
			queryParams : {},
	...
	(function($) {
		...
		function init(_55d) {
			$(_55d).addClass("calendar").html(
					"<div class=\"calendar-header\">" + "<div class=\"calendar-nav calendar-prevmonth\"></div>"
							+ "<div class=\"calendar-nav calendar-nextmonth\"></div>" + "<div class=\"calendar-nav calendar-prevyear\"></div>"
							+ "<div class=\"calendar-nav calendar-nextyear\"></div>" + "<div class=\"calendar-title\">"
							+ "<span class=\"calendar-text\"></span>" + "</div>" + "</div>" + "<div class=\"calendar-body\">"
		...
		function _60b(_60c, _60d) {
			...
			var _611 = $(
					"<div class=\"datagrid-wrap\">" + "<div class=\"datagrid-view\">" + "<div class=\"datagrid-view1\">"
							...
							+ "<div class=\"datagrid-view2\">" + "<div class=\"datagrid-header\">" + "<div class=\"datagrid-header-inner\"></div>"
							+ "</div>" + "<div class=\"datagrid-body\"></div>" + "<div class=\"datagrid-footer\">"
							+ "<div class=\"datagrid-footer-inner\"></div>" + "</div>" + "</div>" + "</div>" + "</div>").insertAfter(_60c);
			_611.panel({
				doSize : false,
				cls : "datagrid"
			});
			...
			_62e.unbind(".datagrid").bind("click.datagrid", function(e) {
				...
				if (e.pageX < p2 && e.pageX > p1) {
					...
					function(e) {
						var p1 = $(this).offset().left + 5;
						var p2 = $(this).offset().left + $(this)._outerWidth() - 5;
						var cond = opts.resizeHandle == "right" ? (e.pageX > p2) : (opts.resizeHandle == "left" ? (e.pageX < p1)
										...
										$("head")
												.append(
														"<style id=\"datagrid-group-style\">"
																...
																+ opts.groupHeight + "px;padding:0 4px;}" + ".datagrid-group-expander{width:"
																+ opts.expanderWidth + "px;text-align:center;padding:0}"
	...
	(function($) {
		...
		function _882(_883, _884) {
			...
			function _887(tr, _888) {
				$("<tr class=\"treegrid-tr-tree\">" + "<td style=\"border:0px\" colspan=\"" + _888 + "\">" + "<div></div>" + "</td>" + "</tr>")
						.insertAfter(tr);
			}
			;
		}
				...
				function _8f3(_8f4, _8f5, _8f6) {
					...
					for ( var i = 0; i < _8f6.length; i++) {
						...
						if (row.children && row.children.length) {
							...
							_8f9.push("<tr class=\"treegrid-tr-tree\"><td style=\"border:0px\" colspan=" + (_8f0.length + (opts.rownumbers ? 1 : 0))
									+ "><div style=\"display:" + v + "\">");
							_8f9 = _8f9.concat(tt);
							_8f9.push("</div></td></tr>");
						}
							...
							if (_907 == opts.treeField) {
								...
								if (row.state == "closed") {
									...
									if (row.children && row.children.length) {
										cc.push("<span class=\"tree-hit tree-expanded\"></span>");
										cc
												.push("<span class=\"tree-icon tree-folder tree-folder-open " + (row.iconCls ? row.iconCls : "")
														+ "\"></span>");
									} else {
										cc.push("<span class=\"tree-indent\"></span>");
	...
	(function($) {
		...
		$.fn.combobox.parseOptions = function(_9d9) {
			var t = $(_9d9);
			return $.extend({}, $.fn.combo.parseOptions(_9d9), $.parser.parseOptions(_9d9, [ "valueField", "textField", "groupField", "mode", "method",
					"url" ]));
		};
	...
	(function($) {
		...
		$.fn.combogrid.parseOptions = function(_a3b) {
			var t = $(_a3b);
			return $.extend({}, $.fn.combo.parseOptions(_a3b), $.fn.datagrid.parseOptions(_a3b), $.parser.parseOptions(_a3b, [ "idField", "textField",
					"mode" ]));
		};
	...
	(function($) {
		function _a3c(_a3d) {
			...
			function _a40(_a47) {
				...
				var _a49 = $("<div class=\"datebox-button\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"width:100%\"><tr></tr></table></div>")
						.appendTo(_a48);
				var tr = _a49.find("tr");
				for ( var i = 0; i < opts.buttons.length; i++) {
					var td = $("<td></td>").appendTo(tr);
					var btn = opts.buttons[i];
					var t = $("<a class=\"datebox-button-a\" href=\"javascript:void(0)\"></a>").html($.isFunction(btn.text) ? btn.text(_a47) : btn.text)
							.appendTo(td);
	...
	(function($) {
		...
		function _a6b(_a6c) {
			...
			return new Date(date.getFullYear(), date.getMonth(), date.getDate(), t.timespinner("getHours"), t.timespinner("getMinutes"), t
		...
		function init(_a8d) {
			var _a8e = $(
					"<div class=\"slider\">" + "<div class=\"slider-inner\">" + "<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"
							...
							+ "<input type=\"hidden\" class=\"slider-value\">" + "</div>").insertAfter(_a8d);
			var t = $(_a8d);
