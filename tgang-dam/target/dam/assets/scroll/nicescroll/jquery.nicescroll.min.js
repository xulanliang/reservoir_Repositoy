...
-- version 3.5.0 BETA5
*/
var _scrollPlugin = function ($, win) {
...
//调用niceScroll
win.doNiceScroll = function(obj){
    obj = obj || '*[data-scroll="true"]';
    $(obj).attr('data-scroll',true).each(function(){
        var $color = $(this).attr('data-cursor-color') || '#bbb', //滚动条颜色
            $background = $(this).attr('data-cursor-background') || '', //滚动条背景颜色
            $opacity = $(this).attr('data-cursor-opacity') || 0.9, //滚动条颜色不透明度，范围从1到0
            ...
            $iframe = !$(this).attr('data-iframeID') ? '' : $($(this).attr('data-iframeID'));
...
if (typeof dseDefine === 'function') {
    dseDefine(function (require, exports, module) {
        return _scrollPlugin(require('jquery'), window);
    });
} else {
    //依赖jquery
    _scrollPlugin(jQuery, window);
}