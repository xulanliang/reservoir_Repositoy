        ...
        $.fn.extend({
            vform: function (options) {
                ...
                return this.each(function () {
                    ...
                    $(_this).delegate(':input[data-vform]', 'focus', function () {
                        var $this = $(this),
                                $v = $this.val(),
                    ...
                    $(_this).delegate(':input[data-vform]', 'blur', function () {
                        var $this = $(this);
                        if (o.isTips == true) {
                            v($this);
                        }
                    ...
                    $(_this).delegate(':input[data-vform]', 'input propertychange', function () {
                        var $this = $(this),
                                $v = $this.val(),
...
if (typeof dseDefine === 'function') {
    dseDefine(function (require, exports, module) {
        return _vformPlugin(require('jquery'), window);
    });
} else {
    //依赖jquery
