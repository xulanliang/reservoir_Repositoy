                ...
                switch (g) {
                    case SWFUpload.QUEUE_ERROR.QUEUE_LIMIT_EXCEEDED:
                        if (e.queueSizeLimit > f) {
                            ...
                            this.queueData.errorMsg += "选定的文件的数目超过了队列大小限制 (" + e.queueSizeLimit + ")."
                        }
                        break;
                    ...
                    case SWFUpload.QUEUE_ERROR.ZERO_BYTE_FILE:
                        this.queueData.errorMsg += '文件 "' + d.name + '" 是空的.';
                        break;
                    case SWFUpload.QUEUE_ERROR.FILE_EXCEEDS_SIZE_LIMIT:
                        this.queueData.errorMsg += '文件 "' + d.name + '" 不是指定的文件类型 (' + e.fileTypeDesc + ").";
                        break
                }
            }
