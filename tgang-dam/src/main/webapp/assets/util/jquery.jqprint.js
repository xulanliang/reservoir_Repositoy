...
var _buildJqPrint = function($) {
	/*
	 * ! jQuery Migrate - v1.1.0
	 */
...
//						console.trace()
		...
		var attrFn = {}, oldAttr = jQuery.attr, valueAttrGet = jQuery.attrHooks.value
		...
		jQuery.fn.init = function(selector, context, rootjQuery) {
			...
			if (selector && typeof selector === "string"
				...
				if (jQuery.parseHTML) {
					return oldInit.call(this, jQuery.parseHTML(jQuery
							.trim(selector), context, true), context,
							rootjQuery)
				}
			}
		...
		migrateWarnProp(jQuery, "browser", browser,
...
if (typeof dseDefine === 'function') {
	dseDefine(function(require, exports, module) {
		return _buildJqPrint(require('jquery'));
	});
} else {
	// 依赖jquery
	_buildJqPrint(jQuery);
}
