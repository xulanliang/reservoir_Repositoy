...
], function (Evented, declare, lang, xhr, arrayUtils, html, topic,
             domStyle, domConstruct, win, domClass) {
    //
    //
        ...
        constructor: function (node, options) {
            ...
            if (this.uri) {
                ...
                xhr(this.uri, {
                    ...
                    lang.hitch(this, this.configDataLoaded),
                    lang.hitch(this, this.configDataLoadError)
                );
            }
            //
            //
