    ...
    var module = (function () {
        ...
        return {
            ...
            getColorDzx: function (dValue) {
                var color;
                var alpha = 0.5;
                if (dValue == 0)//0级,降雨量小于0，透明无颜色
                {
                    color = new EsriColor([0, 0, 0, alpha]);
                }
                else if (dValue == 5)//一级,降雨量小于5,淡绿色
                {
                    color = new EsriColor([165, 243, 141, alpha]);
                }
                else if (dValue == 10)//二级,降雨量5-15,绿色
                {
                    color = new EsriColor([58, 182, 58, alpha]);
                }
                else if (dValue == 25)//三级,降雨量15-30,淡蓝色
                {
                    color = new EsriColor([91, 180, 248, alpha]);
                }
                else if (dValue == 50)//四级,降雨量30-70,深蓝色
                {
                    color = new EsriColor([2, 2, 250, alpha]);
                }
                else if (dValue == 100)//五级,降雨量70-140,粉红色
                {
                    color = new EsriColor([253, 0, 249, alpha]);
                }
                else if (dValue == 250)//六级,降雨量140-250,紫红色254,46,73，113,12,16
                {
            ...
            getColorDzm: function (dValue) {
                ...
                else if (dValue == 1)//一级,降雨量小于10,淡绿色
                {
                    color = new EsriColor([165, 243, 141, alpha]);
                }
                else if (dValue == 2)//二级,降雨量5-15,绿色
                {
                    color = new EsriColor([58, 182, 58, alpha]);
                }
                else if (dValue == 3)//三级,降雨量15-30,淡蓝色
                {
                    color = new EsriColor([91, 180, 248, alpha]);
                }
                else if (dValue == 4)//四级,降雨量30-70,深蓝色
                {
                    color = new EsriColor([2, 2, 250, alpha]);
                }
                else if (dValue == 5)//五级,降雨量70-140,粉红色
                {
                    color = new EsriColor([253, 0, 249, alpha]);
                }
                else if (dValue == 6)//六级,降雨量140-250,紫红色254,46,73
                {
                    color = new EsriColor([254, 46, 73, alpha]);
                }
                else //其他
            ...
            createTextSymbol: function (options) {
                ...
                var textSymbol = new TextSymbol(content).setColor(
                    new Color(textColor)).setAlign(Font.ALIGN_START).setAngle(fontAngle).setFont(
                    new Font(fontSize).setWeight(Font.WEIGHT_BOLD));
                //
                return textSymbol;
            },
            /**
            ...
            createSimpleFillSymbol: function (options) {
                ...
                var sfs = new SimpleFillSymbol(
                    ...
                    new SimpleLineSymbol(SimpleLineSymbol.STYLE_SOLID, new Color(borderColor),borderWidth),
                    new Color(fillColor)
                );
                //
                return sfs;
            ...
            createPictureMarkerSymbol: function (options) {
                ...
                var url = options.url ? arcgisPath + styleName + options.url : arcgisPath + styleName + "/img/arrow.png";
                //
